...
st.markdown(
    ...
    @media (max-width: 768px) {
        ...
        .operations-header { padding: 15px 16px; }
        .operations-header h1 { font-size: 24px; line-height: 1.15; overflow-wrap: anywhere; }
        .operations-header p, .section-title, .insight-title, .insight-text { overflow-wrap: anywhere; }

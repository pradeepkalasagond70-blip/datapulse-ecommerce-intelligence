...
st.markdown(
    ...
    @media (max-width: 768px) {
        ...
        .market-header { padding: 15px 16px; }
        .market-header h1 { font-size: 24px; line-height: 1.15; overflow-wrap: anywhere; }
        .market-header p, .section-title, .insight-title, .insight-text { overflow-wrap: anywhere; }

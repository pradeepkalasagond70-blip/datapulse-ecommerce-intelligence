...
st.markdown(
    ...
    @media (max-width: 768px) {
        ...
        .sales-header { padding: 15px 16px; }
        .sales-header h1 { font-size: 24px; line-height: 1.15; overflow-wrap: anywhere; }
        .sales-header p, .section-title, .insight-title, .insight-text { overflow-wrap: anywhere; }
